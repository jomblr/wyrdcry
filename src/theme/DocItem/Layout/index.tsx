/**
 * Swizzled to use merged TOC length (MDX headings + fighters from JSON) for visibility.
 */
...
export default function DocItemLayout({ children }: { children: React.ReactNode }): React.ReactNode {
