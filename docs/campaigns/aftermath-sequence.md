...
|32|<span id="hallucinations">**[Trait] Hallucinations**</span>: This warrior must take a Panic test whenever they are activated within 1” of an enemy warrior|
|33|<span id="claustrophobic">**[Trait] Claustrophobic**</span>: Whenever this fighter ends a move action (or is activated within) an enclosed terrain piece, it must take a Panic test|
...
|62|<span id="captured">**Captured**</span>: The fighter is captured by your opponent's warband. You must offer your opponent half of the fighter's recruitment cost, or concede a wyrdstone shard to get them back.|
...
|65|<span id="terrible-scars">**[Trait] Terrible scars**</span>: Fighters targeting this fighter with a melee attack action must take a Panic test before making hit rolls|
