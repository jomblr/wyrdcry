...
## Example
![A breakdown of a terrain piece](/img/building.webp)
...
### 4) Ladders
Ladders are obstacles that allow fighters to climb more easily. When climbing vertically on a ladder, do not count the vertical distance as double.
