...
# Keywords
## Racial Keywords
These keywords are primarily used when a fighter gains Renown and makes a characteristic increase, but are sometimes used for special rules such as hatred.
## Faction Keywords
- `Witch Hunters`
- `Sisters of Sigmar`
- `Mercenaries`
...
- <span Id='Leader'>`Leader`</span>
	- Friendly fighters within 6" can use the Leader's Bravery characteristic when taking [Panic tests.](/docs/rules/the-battle-round/the-combat-phase/panic)
...
- <span Id='Hero'>`Hero`</span>
	...
	- Can make a [Heroic Reaction](/docs/rules/the-battle-round/the-combat-phase/reactions#heroic-reaction) once per battle
...
- <span Id='Wizard'>`Wizard`</span>
	...
	- Can make the [Channel Magic](/docs/rules/the-battle-round/the-combat-phase/other-actions#channel-magic) action
